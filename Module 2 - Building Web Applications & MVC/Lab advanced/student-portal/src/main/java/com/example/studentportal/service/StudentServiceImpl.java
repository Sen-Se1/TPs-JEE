...
public class StudentServiceImpl implements StudentService {
    ...
    public StudentServiceImpl() {
        ...
        Student student1 = new Student(idCounter.incrementAndGet(), "John Doe", 21,
                "john.doe@example.com", "Computer Science", "CS123456");
        Student student2 = new Student(idCounter.incrementAndGet(), "Jane Smith", 22,
                "jane.smith@example.com", "Mathematics", "MT789012");
        Student student3 = new Student(idCounter.incrementAndGet(), "Bob Johnson", 20,
                "bob.johnson@example.com", "Physics", "PH345678");
        Student student4 = new Student(idCounter.incrementAndGet(), "Alice Williams", 23,
                "alice.w@example.com", "Engineering", "EN901234");
        Student student5 = new Student(idCounter.incrementAndGet(), "Charlie Brown", 19,
                "charlie.b@example.com", "Computer Science", "CS567890");

        studentDb.put(student1.getId(), student1);
        studentDb.put(student2.getId(), student2);
        studentDb.put(student3.getId(), student3);
        studentDb.put(student4.getId(), student4);
        studentDb.put(student5.getId(), student5);
    }
